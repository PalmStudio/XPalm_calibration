function evaluate(df_plant, df_female, df_leaf, path_outputs)
    ...
    return (; fig_phyllochron, fig_n_bunch, fig_biomass_dry_fruit_per_bunch, fig_leaf_area_17, fig_FFB, fig_avg_n_fruit_per_bunch, fig_biomass_fresh_fruit_per_bunch, fig_bunch_dry_biomass, fig_bunch_dry_mass_per_bunch, fig_n_fruit, fig_bunch_fresh_mass_per_bunch, fig_stalk_dry_biomass_per_bunch, fig_stalk_fresh_biomass_per_bunch)
end