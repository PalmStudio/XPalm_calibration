...
write.csv(etude.morris$X, "2-results/doe_test.csv", row.names = FALSE)

save(etude.morris, file = "2-results/etude_morris.RData")

test=read.csv("2-results/doe_test.csv") 
